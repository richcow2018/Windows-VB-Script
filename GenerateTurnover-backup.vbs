...
Sub run_macro()
    ...
    & Year(dteNow) & "_TO" & Year(dteNow) & ".xlsx", 51, "TO" & Year(dteNow)
...
Sub SendEmail()
	...
	mail_body = "Dear Weiss, " & vbNewLine & vbNewLine & "It is turnover report." _
    ...
    With objMI
        ...
        .Attachments.Add "C:\Users\user.name\Desktop\turnover_report\" &  Right("0" & Day(dteNow), 2) & "_" & Right("0" & Month(dteNow), 2) & "_" _
    & Year(dteNow) & "_TO" & Year(dteNow) & ".xlsx"
